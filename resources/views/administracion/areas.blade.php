                ...
                <table border="0" id="areas" class="display table m-0" style="width:100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="#" class="btn btn-danger btn-rounded" title="Eliminar" data-toggle="modal" data-target="#area_delete" onclick="obtener_datos_area('{{$value['id']}}');" id="tableDeleteButton"><i class="icon-trash"></i></a></td>
