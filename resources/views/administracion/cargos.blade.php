                ...
                <table border="0" id="cargos" class="display table m-0" style="width:100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="#" class="btn btn-danger btn-rounded" title="Eliminar" data-toggle="modal" data-target="#cargo_delete" onclick="obtener_datos_cargo('{{$value['id']}}');" id="tableDeleteButton"><i class="icon-trash"></i></a></td>
